...
if(is_super_admin())
	echo '<p style="margin:-10px 0 10px 0; text-align:center;"><small>'.sprintf(__('<a href="%s">Reader-Einstellungen anpassen</a>', 'wmd_prettyplugins'), admin_url('network/settings.php?page=msreader.php')).'</small></p>';
