...
class WMD_MSReader_Module_UserWidget extends WMD_MSReader_Modules {
    ...
    function add_widget($widgets) {
        ...
        if(function_exists('avatars_page_edit_blog_avatar'))
            $user_info['main']['avatar'] = '<div class="user-avatar"><a title="Change avatar" href="'.admin_url('users.php?page=user-avatar').'"><div class="change-avatar-text">'.__( 'Avatar ändern', 'wmd_msreader' ).'</div>'.get_avatar($current_user->ID, 48).'</a></div>';
        else
