<?php
$module = array(
	'name' => __( 'Suche', 'wmd_msreader' ),
	'description' => __( 'Ermöglicht die Suche nach Beiträgen nach Titel, Autor oder Tag', 'wmd_msreader' ),
	'slug' => 'search', 
    ...
    function add_widget($widgets) {
        ...
        $search_html = '
            <form id="msreader-searc" action="'.add_query_arg(array('module' => 'search'), admin_url('index.php?page=msreader.php')).'" method="post">
                ...
                <input name="args[search_author]" id="search_author" type="checkbox" value="1" '.checked( isset($this->args['search_author']) ? $this->args['search_author'] : '', true, false ).'>'.__('Autor', 'wmd_msreader').' 
                </label>
                ...
                <input class="button button-primary right" type="submit" value="'.__('Suche', 'wmd_msreader').'"/>
            </form>
        ';
